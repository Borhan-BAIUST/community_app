...
class _$CommentModelImpl implements _CommentModel {
  ...
  @override
  String toString() {
    return 'CommentModel(id: $id, schoolId: $schoolId, feedId: $feedId, userId: $userId, replyCount: $replyCount, likeCount: $likeCount, commentTxt: $commentTxt, parrentId: $parrentId, createdAt: $createdAt, updatedAt: $updatedAt, file: $file, privateUserId: $privateUserId, isAuthorAndAnonymous: $isAuthorAndAnonymous, gift: $gift, sellerId: $sellerId, giftedCoins: $giftedCoins, replies: $replies, reactionTypes: $reactionTypes, user: $user, totalLikes: $totalLikes, privateUser: $privateUser, commentlike: $commentlike)';
  }
